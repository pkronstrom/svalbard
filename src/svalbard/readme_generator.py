...
def generate_drive_readme(drive_path: Path) -> Path:
    ...
    lines = [
        ...
        "keyboard-driven terminal UI with grouped menus for Search, Library,",
        "Maps, Local AI, Tools, and any pack-specific extras included on",
        "this drive.",
        "",
        "### On iPhone / iPad",
        "",
        ...
        "| `data/`    | SQLite databases — searchable reference data    |",
        "| `books/`   | PDF and EPUB — books and documents              |",
        "| `models/`  | GGUF — local language models                    |",
        "| `apps/`    | Standalone web apps (CyberChef, map viewer, etc.) |",
