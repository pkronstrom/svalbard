...
if (BASEMAP) {
  ...
  style.layers.push(
    ...
    { id: "boundaries", type: "line", source: "basemap", "source-layer": "boundaries",
      paint: { "line-color": "#ccc", "line-width": 1, "line-dasharray": [3, 2] } },
    ...
    { id: "places", type: "symbol", source: "basemap", "source-layer": "places",
      layout: { "text-field": "{name}", "text-size": ["interpolate", ["linear"], ["zoom"], 6, 10, 14, 14] },
